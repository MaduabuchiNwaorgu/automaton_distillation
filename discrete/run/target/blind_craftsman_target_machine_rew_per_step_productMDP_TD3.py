...
from discrete.run.env.blind_craftsman import blind_craftsman_rew_per_step_env_config,blind_craftsman_rew_per_step_env_config_cont
...
config = student_config_v1(
    ...
    student_run_name="blind_craftsman_target_machine_rew_per_step_productMDP_TD3",
    device=device,
