...
from discrete.run.env.blind_craftsman import blind_craftsman_rew_per_step_env_config_cont, blind_craftsman_aps, blind_craftsman_ltlf
...
if __name__ == '__main__':
    ...
    config = student_config_reward_machine(
        ...
        student_run_name="blind_craftsman_7_target_rew_per_step_TD3_CRM",
        agent_cls=TD3_Agent,
        device=device,
