...
from discrete.run.env.gold_mine_7 import gold_mine_automaton
from discrete.run.utils import student_config_reward_machine

device = torch.device("cuda:0")
config = student_config_reward_machine(
    env_config=gold_mine_rew_per_step_env_config_7,
    teacher_run_name="gold_mine_machine_rew_per_step",
    student_run_name="gold_mine_target_machine_7_rew_per_step_CRM",
