...
config = teacher_config_v1(blind_craftsman_rew_per_step_env_config_7_obstacles_cont, "blind_craftsman_obstacles_teacher_rew_per_step_productMDP_TD3", device,
