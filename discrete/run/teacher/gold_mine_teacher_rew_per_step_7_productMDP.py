...
from automaton_transfer.run.env.gold_mine_7 import gold_mine_rew_per_step_env_config_7
from automaton_transfer.run.env.gold_mine_7 import gold_mine_automaton, gold_mine_ap_extractor
